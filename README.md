...
## 📋 Description
Dashboard Power BI pour l'analyse financière 
complète d'une banque islamique marocaine 
...
## 👤 Auteur
**Yassir Bouchnaf**
Étudiant en BUSINESS AND DATA MANAGEMENT — ESITH Casablanca
## 📁 Structure du Projet
